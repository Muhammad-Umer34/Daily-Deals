...
const StoreSignupCard = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col lg:flex-row bg-zinc-950 font-sans text-white overflow-hidden">
      {/* Left Column: Premium Brand Visual */}
      <div className="hidden lg:block lg:w-1/2 relative bg-zinc-950 h-full">
        <img
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 h-full bg-gradient-to-br from-zinc-950 via-slate-900 to-zinc-900 relative overflow-hidden">
        {/* Mesh Ambient Glow */}
        ...
        <div className="w-full max-w-md max-h-[85vh] bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl rounded-2xl p-8 text-white relative z-10 flex flex-col">
          <h2 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent mb-2">
            Brand Registration
          </h2>
          <p className="text-gray-400 text-sm mb-6 flex-shrink-0">
            ...
            <button 
              ...
              className="text-blue-400 hover:text-blue-300 font-semibold underline bg-transparent border-0 cursor-pointer p-0"
            >
              Sign In
            </button>
          </p>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 overflow-y-auto flex-1 pr-1 scrollbar-thin">
